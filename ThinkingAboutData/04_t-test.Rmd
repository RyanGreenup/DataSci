...
The confidence interval is that the population average would be below -14, this suggests that if multiple samples of this population were taken and this corresponding confidence intervals drawn, the true population 

the probability of receiving these results when the null hypothesis is true

##### Alternative Hypothesis: Two-Sided


* TODO The confidence interval depends on the alternative hypothesis, It should generally however be drawn from the null hypothesis, 0.
