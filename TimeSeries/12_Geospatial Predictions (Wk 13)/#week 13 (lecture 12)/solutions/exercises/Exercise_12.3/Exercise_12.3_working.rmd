...
The transformation can be acheived by changing the `proj4string`.
This is provided in the `?meuse` help page:
...
```
  ...
  data frame that was required in part 1 (`lead.pred.df`),
...
The surface plot re-inforces the fact that the lead levels are seemingly lowest
within the river with spikes at certain shore locations.
